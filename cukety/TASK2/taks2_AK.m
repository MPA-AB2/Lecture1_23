...
%% nacteni obrazku
im = im2double(imread('image_blurred.png'));
% figure; imshow(im);
imR = im(:,:,1);
imG = im(:,:,2);
imB = im(:,:,3);
...
[NRMSE_PSF, RMSE_Image, PSNR] = evaluateMotion("C:\Users\ceibu\Downloads\Lecture2_23-cukety\Lecture2_23-cukety\cukety\TASK2\Lecture2_data\vysledky.mat")
